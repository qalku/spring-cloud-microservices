...
import pl.mw.paymentservice.service.PostService;

import java.util.List;

import static org.springframework.hateoas.server.mvc.WebMvcLinkBuilder.linkTo;
import static pl.mw.paymentservice.controller.PostDtoMapper.mapToPostDtos;
...
public class PostController {
    ...
    @GetMapping("/payments/posts/comments")
